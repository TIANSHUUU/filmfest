...
export function CategoryFilter({ categories, value, onChange }:
  ...
  return (
    <select aria-label="筛选片单" value={value} onChange={(e) => onChange(e.target.value)}
      style={{ marginLeft: 'auto', padding: '4px 8px', borderRadius: 10, fontSize: 13,
        fontFamily: 'inherit', background: 'transparent', color: '#c9b58a',
        border: '1px solid rgba(233,196,106,.3)', maxWidth: 160 }}>
